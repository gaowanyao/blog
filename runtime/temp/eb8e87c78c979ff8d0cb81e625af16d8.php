<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/www/wwwroot/blog.gcan.top/public/../application/index/view/index/index.html";i:1506175258;s:78:"/www/wwwroot/blog.gcan.top/public/../application/index/view/Public/header.html";i:1507306451;s:83:"/www/wwwroot/blog.gcan.top/public/../application/index/view/Public/index_right.html";i:1507269722;s:78:"/www/wwwroot/blog.gcan.top/public/../application/index/view/Public/footer.html";i:1505896522;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="uyan_auth" content="0fb5c9aa0a" />
                                               ...
                                               <div class="blog-post-lg bordered blog-container">
                                                   ...
                                                   <div class="blog-post-content">
                                                       <h2 class="blog-title blog-post-title">
                                                           <a href="<?php echo $access_index_url; ?>/single_page?cc=<?php echo $vo['id']; ?>.html"><?php echo $vo['title']; ?></a>
                                                       </h2>

                                                       <div class="row">
                                                           <div class="blog-img-thumb col-lg-2 col-md-2  col-sm-2 col-xs-12" style="height: 113px;margin-bottom:10px;">
                                                               <a href="<?php echo $access_index_url; ?>/single_page?cc=<?php echo $vo['id']; ?>.html">
                                                                   <!--<img style="height: 153px;" src="__STATIC__/assets/pages/img/page_general_search/4.jpg" />-->
                                                                   <img style="width: 90%;height: 100%;" src="<?php echo $vo['article_picture']; ?>" alt="<?php echo $vo['title']; ?>" title="<?php echo $vo['title']; ?>" onerror="javascript:this.src='__STATIC__/img/kaola.jpg';"  />
                                                           ...
                                                           <div style="text-indent: 1em;">
                                                               <a href="<?php echo $access_index_url; ?>/single_page?cc=<?php echo $vo['id']; ?>.html" class="btn blue" style="margin-top:10px;margin-bottom:10px;">
