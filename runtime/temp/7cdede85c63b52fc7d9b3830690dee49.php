...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse" >
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item  <?php if('picture' == 'config'){ echo ' active open';} ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  <?php if('article_picture' == 'gcan_config'){ echo ' active open';} ?>">
                                            ...
                                            <div class="mt-card-item">
                                                <div class="mt-card-avatar mt-overlay-1">
                                                    ...
                                                    <div class="mt-overlay">
                                                        <ul class="mt-info">
                                                            <li>
                                                                <a class="btn default btn-outline" href="/index.php/admin/index/article_picture_path?id=<?php echo $vo['id']; ?>">
                                                                    <i class="icon-magnifier"></i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                ...
                                                <div class="mt-card-content">
                                                    <a href="/index.php/admin/index/update_article?id=<?php echo $vo['id']; ?>" style="text-decoration: none;"><h3 class="mt-card-name" style="text-decoration: none;width:90%;margin:0 auto;margin-bottom: 10px;overflow:hidden;word-break:keep-all;white-space:nowrap;text-overflow:ellipsis;"><?php echo $vo['title']; ?></h3></a>
