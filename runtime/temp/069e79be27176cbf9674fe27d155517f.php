...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse" >
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item start  <?php if('config' == 'article'){ echo ' active open';} ?>">
                ...
                <ul class="sub-menu">
                    <li class="nav-item start  <?php if('gcan_config' == 'article'){ echo ' active open';} ?>">
                        <a href="article" class="nav-link ">
                            <i class="icon-bar-chart"></i>
                            <span class="title">文章列表</span>
                        </a>
                    </li>
                    <li class="nav-item start   <?php if('gcan_config' == 'add_article'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if('config' == 'picture'){ echo ' active open';} ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  <?php if('gcan_config' == 'article_picture'){ echo ' active open';} ?>">
            ...
            <li class="nav-item  <?php if('config' == 'config'){ echo ' active open';} ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <ul class="sub-menu">
                    <li class="nav-item  <?php if('gcan_config' == 'gcan_config'){ echo ' active open';} ?>">
                        ...
                        <div class="portlet light form-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-green sbold uppercase">网站配置</span>
                                </div>

                            </div>
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="gcan_config" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="domain" id="title" placeholder="请输入域名">

                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-3">数据库名</label>
                                            <div class="col-md-3">

                                                <input type="text" class="form-control" name="database_name" placeholder="请输入数据库名">

                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-3">数据库用户名</label>
                                            <div class="col-md-3">

                                                <input type="text" class="form-control" name="database_username" placeholder="请输入数据库用户名">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="database_pwd" placeholder="请输入数据库密码">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <button type="submit" class="btn btn-outline grey-salsa">提交</button>
